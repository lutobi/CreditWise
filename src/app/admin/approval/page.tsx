...
export default function ApprovalPage() {
    ...
    const handleViewBorrowerHistory = async (userId: string, fullName: string) => {
        ...
        } catch (e) { console.error("History network error:", e); }
    }
                                ...
                                <div className="grid md:grid-cols-4 gap-6">
                                    ...
                                    <div className="text-center md:text-left md:col-span-1 border-b md:border-b-0 md:border-r border-slate-100 pb-4 md:pb-0 md:pr-4">
                                        ...
                                        <div className="flex flex-col gap-2 mt-4">
                                            ...
                                            <Button variant="link" className="h-auto p-0 text-blue-600" onClick={() => handleViewBorrowerHistory(item.user_id, item.full_name)}>
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-slate-50 text-slate-500 font-medium border-b sticky top-0">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-center">Repayment</th>
                                    </tr>
                                </thead>
